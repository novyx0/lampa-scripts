(function() {
  ...
  var Defined = {
    api: 'lampac',
    localhost: 'http://46.173.137.116:9118/',
  ...
  if (!window.rch || !window.rch['http://162.217.249.168:9876']) {
    Lampa.Utils.putScript(["http://162.217.249.168:9876/invc-rch.js"], function() {}, false, function() {
      if (!window.rch['http://162.217.249.168:9876'].startTypeInvoke)
        window.rch['http://162.217.249.168:9876'].typeInvoke('http://162.217.249.168:9876', function() {});
    }, true);
  }

  function rchInvoke(json, call) {
    if (window.hubConnection && window.hubConnection['http://162.217.249.168:9876'])
      window.hubConnection['http://162.217.249.168:9876'].stop();

    if (!window.hubConnection)
      window.hubConnection = {};

    window.hubConnection['http://162.217.249.168:9876'] = new signalR.HubConnectionBuilder().withUrl(json.ws).build();
    window.hubConnection['http://162.217.249.168:9876'].start().then(function() {
      window.rch['http://162.217.249.168:9876'].Registry(window.hubConnection['http://162.217.249.168:9876'], function() {
        call();
      });
    })["catch"](function(err) {
  ...
  function rchRun(json, call) {
    if (typeof signalR == 'undefined') {
      Lampa.Utils.putScript(["http://162.217.249.168:9876/signalr-6.0.25_es5.js"], function() {}, false, function() {
        rchInvoke(json, call);
      }, true);
    } else {
      rchInvoke(json, call);
  ...
  function component(object) {
    ...
    if (balansers_with_search == undefined) {
      ...
      network.silent(account('http://162.217.249.168:9876/lite/withsearch'), function(json) {
    ...
    this.requestParams = function(url) {
	  ...
	  query.push('rchtype=' + (window.rch['http://162.217.249.168:9876'] ? window.rch['http://162.217.249.168:9876'].type : ''));
  ...
  if (false) {
    if (Platform.is('browser') && location.host.indexOf("127.0.0.1") !== -1) {
      ...
      $.get('http://162.217.249.168:9876/player-inner/' + element.url);
      return;
    }
  ...
  function startPlugin() {
    window.lampacHPmicro3_plugin = true;
    var manifst = {
      type: 'video',
      version: '1.5.1',
      name: 'ArcadiA-EUY',
      ...
      onContextLauch: function onContextLauch(object) {
        resetTemplates();
        Lampa.Component.add('lampacHPmicro3', component);
  ...
  if (!window.lampacHPmicro3_plugin) startPlugin();
