(function() {
    ...
    setTimeout(function() {
        ...
        // Функция обновления кнопок (как в оригинале)
        function updateButtons() {
            // Обновляем только те кнопки, которые ещё не обновлены
        ...
        // Слушатель для обновления кнопок при смене страниц
        ...
        if (window.plugin) {
            window.plugin('unified_buttons_plugin', {
                type: 'component',
                name: 'Кнопки + очистка кеша',
                version: '3.0.1',
                author: 'Oleksandr',
                description: 'Оптимізовані кнопки без дублювання'
            });
        }
