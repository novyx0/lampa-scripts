(function() {
    ...
    setTimeout(function() {
        ...
        // Простое обновление кнопок ТОЛЬКО ОДИН РАЗ
        ...
        // ТОЛЬКО однократный вызов обновления кнопок
        updateButtons();

        // Регистрация плагина
        if (window.plugin) {
            window.plugin('clean_buttons_plugin', {
                type: 'component',
                name: 'Чистые кнопки без дублирования',
                version: '3.1.0',
                author: 'Oleksandr',
                description: 'Кнопки + кеш БЕЗ дублирования'
            });
        }
